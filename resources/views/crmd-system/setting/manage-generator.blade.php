                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-wrap gap-2 justify-content-center justify-content-md-start">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#addGeneratorModal"
                                    class="btn btn-primary d-flex align-items-center gap-2" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Add Generator">
                                    <i class="ti ti-plus f-18"></i>
                                    <span class="d-none d-md-inline">Add Generator</span>
                                </button>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                <label for="generator_code" class="form-label">Generator Code <span
                                                        class="text-danger">*</span></label>
                                                <input type="text"
                                                    class="form-control input-code @error('generator_code') is-invalid @enderror"
