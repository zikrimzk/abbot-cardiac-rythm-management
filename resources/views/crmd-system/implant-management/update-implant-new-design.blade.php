                        ...
                        <div class="card border-0">
                            <div class="card-header">
                                <h5 class="card-title mb-0">
                                    <i class="fas fa-edit me-2"></i>Update Implant
                                </h5>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-1 mb-3">
                                            ...
                                            <input type="text" name="implant_generator_qty"
                                                ...
                                                placeholder="Qty" value="{{ $im->implant_generator_qty }}">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="implant_generator_itemPrice"
                                                    ...
                                                    placeholder="0.00" value="{{ $im->implant_generator_itemPrice }}">
                                                @error('implant_generator_sn')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                                ...
                                                <div class="model-loop">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-1 mb-3">
                                                            ...
                                                            <input type="text" name="model_qty[]"
                                                                class="form-control qty-input @error('model_qty') is-invalid @enderror"
                                                                placeholder="Qty" value="{{ $imd->implant_model_qty }}">
                                                            @error('model_qty')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="implant_pt_address" id="implant_pt_address"
                                                    ...
                                                    rows="3">{{ $im->implant_pt_address }}</textarea>
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-end">
                                <button type="submit" class="btn btn-primary btn-submit d-flex align-items-center"
                                    ...
                                    <i class="ti ti-edit me-2"></i> Update Implant
                                </button>
                            </div>
                        </div>
                    </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            function validateAllModelLoops() {
                ...
                $("#update-implant-btn").prop("disabled", anyInvalid);
            }
