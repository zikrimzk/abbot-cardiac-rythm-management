                        ...
                        <div class="card border-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="sender_email" id="sender_email"
                                                    ...
                                                    placeholder="email@company.com" value="{{ old('sender_email') }}">
                                            </div>
                                            @error('sender_email')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="sender_telno" id="sender_telno"
                                                    ...
                                                    placeholder="+60 3 1234 5678" value="{{ old('sender_telno') }}">
                                            </div>
                                            @error('sender_telno')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="sender_fax" id="sender_fax"
                                                    ...
                                                    placeholder="+60 3 1234 5679" value="{{ old('sender_fax') }}">
                                            </div>
                                            @error('sender_fax')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="quotation_attn" class="form-label fw-medium">Attn
                                                Name</label>
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="quotation_attn" id="quotation_attn"
                                                    ...
                                                    placeholder="Dr. John Smith" value="{{ old('quotation_attn') }}">
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="quotation_subject" id="quotation_subject"
                                                ...
                                                value="{{ old('quotation_subject') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="generator_id" id="generator_id"
                                                ...
                                                <option value="" selected disabled>- Select Generator -</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="quotation_unitprice" id="quotation_unitprice"
                                                    ...
                                                    placeholder="0.00" value="{{ old('quotation_unitprice') }}" required>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="quotation_totalprice"
                                                    ...
                                                    placeholder="0.00" value="{{ old('quotation_totalprice') }}"
                                                    readonly>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="quotation_pt_name" id="quotation_pt_name"
                                                    ...
                                                    value="{{ old('quotation_pt_name') }}" required>
                                            </div>
